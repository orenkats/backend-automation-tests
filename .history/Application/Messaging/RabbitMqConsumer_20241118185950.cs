...
public class RabbitMqConsumer
{
    ...
    internal async Task SaveOrderToDatabase(StockOrder order)
    {
        try
        {
            ...
            Console.WriteLine($"[DEBUG] Trader found: {trader.Name}");

            // Save the order
            dbContext.StockOrders.Add(order);
            Console.WriteLine("[DEBUG] Order added to DbContext, saving changes...");
